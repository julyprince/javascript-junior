...
class AltaGama extends Celular {
    constructor(color, peso, rpantalla, rcamara, ram, extra){
    ...
    reconocimientoFacial(){
        alert("inicaindo reconocimiento facial")
    }
    infoaltaGama(){
      return  this.info() + `camara extra: ${this.extra}`;
    }
}  

celular4 = new AltaGama("negro","200g","5.9pul","hd","16GB", "ful HD")
